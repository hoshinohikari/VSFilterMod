...
CAtlMap<DWORD_PTR, CDSMResource*> CDSMResource::m_resources;
    ...
    , tag(0)
{
    ...
    m_resources.SetAt(reinterpret_cast<DWORD_PTR>(this), this);
}
...
{
    CAutoLock cAutoLock(&m_csResources);
    m_resources.RemoveKey(reinterpret_cast<DWORD_PTR>(this));
}
